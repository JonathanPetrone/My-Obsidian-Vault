...
Knowledge accumulation is exponential if you combine it with curiosity and exploration, the more knowledge you have the more you can easily build ([[Current Mental Models & Frameworks#The Matthew Principle|The Matthew Principle]]). To build more skill and knowledge at the same time the concept of [[Be a Thinkerer|Thinkering]] can be useful as it encourages running experiments against what you know, giving you feedback.
...
The right approach for building expertise depends on the nature of the environment, is the domain/area/problem [[Complicated and Complex Expertise|Complicated or Complex]]? 

Complicated domains tend to benefit most from deliberate practice, simplest complete system training and drills. Complex domains tend to benefit from varied context exposure, abstract patterns across instances, first principles. 

There is also the dimension of feedback loops, are they fast or slow? Slow feedback tends to make practice more expensive or difficult, getting any result or any indications is a challenge in itself.

This leads us to a model of different domain spaces and their characteristics:

![[Adaptive expertise (4).jpg|300]]

- [[Fast and Complicated Domain]]
- [[Slow and Complicated Domain]]
- [[Fast and Complex Domain]]
- [[Slow and Complex Domain]]

## Techniques for Rapid Expertise Building
